...
* удаление сообщений из диалога (у другого клиента все сообщения сохраняются)
* удаление целого диалога (у другого клиента диалог не пропадает)
